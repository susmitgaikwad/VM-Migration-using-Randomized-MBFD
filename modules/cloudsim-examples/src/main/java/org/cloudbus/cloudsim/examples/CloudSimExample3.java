...
*/
			...
			for (Host host:hostList) {
				System.out.println("1:"+host.getMaxAvailableMips());
				System.out.println("2:"+host.getTotalMips());
				System.out.println("3:"+host.getVmList().size());
				System.out.println("--------------------------");
				if (host.getVmList().size()>=5) {
			...
			System.out.println("################################################################################################");
			double usedmips=0.0;
			for (Host host_temp:datacenter0.getHostList()) {
				if (host_temp.getVmList().size()>=5) {
					for(Vm vm_temp:host_temp.getVmList()) {
						usedmips=usedmips+vm_temp.getTotalUtilizationOfCpuMips(CloudSim.clock());
					}
				}
				System.out.println("1:"+usedmips);
				System.out.println("2:"+host_temp.getTotalMips());
				System.out.println("3:"+host_temp.getVmList().size());
				System.out.println("--------------------------");
        	...
        	System.out.println("Total run time is: "+(stop-start));
